...
label    = "4MPY_"  # Label before index # if JUG data, idx is not used and single file is assumed.
...
rangeMHz = 1.0     # plus and minus this value around probe frequency is what will be added from each scan step. About FWHM=1.0 MHz should be good. If your mode ran away a bit or you observe unsteady intensities (stitching artifacts), you might want to increase this value
