...
label    = "11750_20000shots_"      # Label before index
startidx =      18   # Starting index (5-digits at end of file names)
endidx   =      18   # Ending index. If single filed set endidx to startidx
