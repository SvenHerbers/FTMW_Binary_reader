...
label    = "O13CS_night469k_"  # Label before index
startidx =      40      # Starting index (5-digits at end of file names)
endidx   =      40      # Ending index. If single filed set endidx to startidx

masklines=      []      # Lines to remove
maskwidth=      0.1     # +-width (MHz) to mask

forcecalc=      False   # False = use existing spectrum, True = force recalculation. For single file recalculation is always forced.
...
stick_dopplerread   = False     # Detect Doppler pairs using stick_exampledoppler
